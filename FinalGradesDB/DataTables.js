...
function handleResponse() {
    if (ajax.readyState === 4) { //server has completed the request
        if (ajax.status === 200 || ajax.status === 304) {
            var r = document.getElementById('tables');
